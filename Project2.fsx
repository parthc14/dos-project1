...
let allActors = 
    [1 .. workRange-1]
    |> List.map(fun id ->   let properties = [|  int(id):> obj; int((id-1)*workRange + 1):>obj; int((id)*workRange):>obj; int(k) :>obj  |]
                            system.ActorOf(Props(typedefof<EchoServer>, properties)))
            
// (((i)-int64(1))*newWorkRange+int64(1), ((i))*newWorkRange, K')  
...
// ((((newActors-int64(1))*newWorkRange)+int64(1)), (N') ,(K'))
// let finalActor = 
